...
async def select_lang_keyboard(message, strings, edit=False):
    ...
    markup.add(InlineKeyboardButton(strings["crowdin_btn"], url="https://t.me/supbuz"))
    if edit:
...
Winie will send you bunch of inline buttons where you can select your prefered language interatively without any hassles!
"""
